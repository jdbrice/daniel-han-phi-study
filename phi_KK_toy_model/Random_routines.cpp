...
// TEST MAIN FUNCTION- TO BE DELETED
int main() {
  TLorentzVector *phi = Random_routines::get_random_lorentz_vector(
      0., 10., 0., 4., 0., 2. * pi, 1.019);

  std::vector<TLorentzVector *> daughter_pair =
      Random_routines::symmetrical_two_body_decay(phi, 0.493);
