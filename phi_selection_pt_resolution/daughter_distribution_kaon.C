...
void daughter_distribution_kaon() {
  ...
  // f1->Draw("same");
  gPad->Print("./Plots_sigma/All/all_ChisqPiPi_ChisqKK.png");
  ...
  // line6->Draw("same");
  gPad->Print("./Plots_sigma/All/all_ChisqEE_ChisqKK.png");
  ...
  //     kRed); // Setting the function's line color to blue for visibility
  // f2->Draw("same");
  gPad->Print("./Plots_sigma/All/all_ChisqPP_ChisqKK.png");
  ...
  gPad->Print("./Plots_sigma/Kaons/kaon_coherent_eta.png");
  makeCan();
  ...
  gPad->Print("./Plots_sigma/Kaons/Reco/reco_phi_mass_pt_proj.png");
  makeCan();
  ...
  gPad->Print("./Plots_sigma/Kaons/Reco/reco_phi_coherent_eta.png");
  ...
  gPad->Print("./Plots_sigma/Kaons/like_signs/ls_mass_background.png");
}
